...
class CV:
            ...
            while True:
                ...
                for cnt in contours:
                    if cv2.contourArea(cnt) > cnt_area:
                        ...
                        cv2.putText(square,text,(x,y+h+20),cv2.FONT_ITALIC,0.5,text_color,text_thickenss)
    ...
    def track(self,max_point:int,color_name:str,cnt_area:int,square_color:tuple,square_thickenss:int,
               line_color:tuple,line_thickenss:int,text:str,text_color:tuple,text_thickenss:int,
               project_name:str):
        ...
        if color_name in self.bounds:
            ...
            while True:
                ...
                for i in range(1,len(points)):
                    cv2.line(square,points[i-1],points[i],(255,255,255),line_thickenss)
